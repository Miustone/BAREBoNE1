...
3. Run BAREbONE1.bat as administrator
...
7. When the image is completed, you will see it in the folder where the script was extracted, with the name BAREbONE1.iso
